...
<form id="recoUpForm">
	...
	<input type="hidden" id="reco_status" name="reco_status" value="1"/>
</form>

<!-- 추천해제  -->
<form id="recoDownForm">
	<input type="hidden" id="member_id" name="member_id" value="${member.member_id }">
	<input type="hidden" id="board_no" name="board_no" value="${boardDTO.board_no }">
	<input type="hidden" id="reco_status" name="reco_status" value="0"/>
</form>
			...
			<div class="panel-body">
						...
						<td>
							<div>
								...
								<span style="display:inline-block;width:79%;text-align:right;">
									추천 ${recoCnt } | 댓글수  ${commentCount} | 조회수 ${boardDTO.board_views} &nbsp;|&nbsp;
				...
				<div>
					...
					<div style="text-align:center">
						<c:if test="${recoStatus == 1}">
							<button type="button" id="rateUpBtn" class="btn btn-default btn-lg" onclick="rateUp('${member.member_id}')" style="background-color:rgb(255,255,0)">추천b</button>
						</c:if>
						<c:if test="${recoStatus == 0}">
							<button type="button" id="rateUpBtn" class="btn btn-default btn-lg" onclick="rateUp('${member.member_id}')" style="background-color:rgb(255,255,255)">추천b</button>
						</c:if>
